...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """history/patient/""" + "$" + """first<[^/]+>/""" + "$" + """last<[^/]+>/""" + "$" + """phone<[^/]+>/""" + "$" + """addr<[^/]+>/""" + "$" + """age<[^/]+>/""" + "$" + """gender<[^/]+>/""" + "$" + """city<[^/]+>""", """@femr.ui.controllers.HistoryController@.indexPatientGetWithRankedMatches(first:String, last:String, phone:String, addr:String, age:Long, gender:String, city:String)"""),
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """search/findMatch/""" + "$" + """first<[^/]+>/""" + "$" + """last<[^/]+>/""" + "$" + """phone<[^/]+>/""" + "$" + """addr<[^/]+>/""" + "$" + """age<[^/]+>/""" + "$" + """gender<[^/]+>/""" + "$" + """city<[^/]+>""", """@femr.ui.controllers.SearchController@.doesPatientExistForSearch(first:String, last:String, phone:String, addr:String, age:Long, gender:String, city:String)"""),
 ...
 ~~~~""",
  ...
  // @LINE:53
  private[this] lazy val femr_ui_controllers_HistoryController_indexPatientGetWithRankedMatches44_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("history/patient/"), DynamicPart("first", """[^/]+""",true), StaticPart("/"), DynamicPart("last", """[^/]+""",true), StaticPart("/"), DynamicPart("phone", """[^/]+""",true), StaticPart("/"), DynamicPart("addr", """[^/]+""",true), StaticPart("/"), DynamicPart("age", """[^/]+""",true), StaticPart("/"), DynamicPart("gender", """[^/]+""",true), StaticPart("/"), DynamicPart("city", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_HistoryController_indexPatientGetWithRankedMatches44_invoker = createInvoker(
    HistoryController_5.get.indexPatientGetWithRankedMatches(fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[Long], fakeValue[String], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "femr.ui.controllers.HistoryController",
      "indexPatientGetWithRankedMatches",
      Seq(classOf[String], classOf[String], classOf[String], classOf[String], classOf[Long], classOf[String], classOf[String]),
      "GET",
      this.prefix + """history/patient/""" + "$" + """first<[^/]+>/""" + "$" + """last<[^/]+>/""" + "$" + """phone<[^/]+>/""" + "$" + """addr<[^/]+>/""" + "$" + """age<[^/]+>/""" + "$" + """gender<[^/]+>/""" + "$" + """city<[^/]+>""",
      """""",
      Seq()
    )
  )
  ...
  // @LINE:55
  private[this] lazy val femr_ui_controllers_SearchController_handleSearch45_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/"), DynamicPart("page", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_SearchController_handleSearch45_invoker = createInvoker(
  ...
  // @LINE:56
  private[this] lazy val femr_ui_controllers_SearchController_doesPatientExist46_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/check/"), DynamicPart("query", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_SearchController_doesPatientExist46_invoker = createInvoker(
  ...
  // @LINE:57
  private[this] lazy val femr_ui_controllers_SearchController_doesPatientExistForSearch47_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/findMatch/"), DynamicPart("first", """[^/]+""",true), StaticPart("/"), DynamicPart("last", """[^/]+""",true), StaticPart("/"), DynamicPart("phone", """[^/]+""",true), StaticPart("/"), DynamicPart("addr", """[^/]+""",true), StaticPart("/"), DynamicPart("age", """[^/]+""",true), StaticPart("/"), DynamicPart("gender", """[^/]+""",true), StaticPart("/"), DynamicPart("city", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_SearchController_doesPatientExistForSearch47_invoker = createInvoker(
    SearchController_9.get.doesPatientExistForSearch(fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[Long], fakeValue[String], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "femr.ui.controllers.SearchController",
      "doesPatientExistForSearch",
      Seq(classOf[String], classOf[String], classOf[String], classOf[String], classOf[Long], classOf[String], classOf[String]),
      "GET",
      this.prefix + """search/findMatch/""" + "$" + """first<[^/]+>/""" + "$" + """last<[^/]+>/""" + "$" + """phone<[^/]+>/""" + "$" + """addr<[^/]+>/""" + "$" + """age<[^/]+>/""" + "$" + """gender<[^/]+>/""" + "$" + """city<[^/]+>""",
      """""",
      Seq()
    )
  )
  ...
  // @LINE:58
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadPatientsJSONGet48_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/typeahead/patients")))
  )
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadPatientsJSONGet48_invoker = createInvoker(
  ...
  // @LINE:60
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadCitiesJSONGet49_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/typeahead/cities")))
  )
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadCitiesJSONGet49_invoker = createInvoker(
  ...
  // @LINE:61
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadDiagnosisJSONGet50_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/typeahead/diagnoses")))
  )
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadDiagnosisJSONGet50_invoker = createInvoker(
  ...
  // @LINE:62
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadMedicationsWithIDJSONGet51_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("search/typeahead/medicationsWithID")))
  )
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadMedicationsWithIDJSONGet51_invoker = createInvoker(
  ...
  // @LINE:63
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadMedicationAdministrationsJSONGet52_route = Route("GET",
  ...
  private[this] lazy val femr_ui_controllers_SearchController_typeaheadMedicationAdministrationsJSONGet52_invoker = createInvoker(
  ...
  // @LINE:65
  private[this] lazy val femr_ui_controllers_PhotoController_GetPatientPhoto53_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("photo/patient/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_PhotoController_GetPatientPhoto53_invoker = createInvoker(
  ...
  // @LINE:66
  private[this] lazy val femr_ui_controllers_PhotoController_GetPhoto54_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("photo/encounter/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_PhotoController_GetPhoto54_invoker = createInvoker(
  ...
  // @LINE:68
  private[this] lazy val femr_ui_controllers_TriageController_indexPopulatedGet55_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("triage/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_TriageController_indexPopulatedGet55_invoker = createInvoker(
  ...
  // @LINE:69
  private[this] lazy val femr_ui_controllers_TriageController_indexGet56_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("triage")))
  )
  private[this] lazy val femr_ui_controllers_TriageController_indexGet56_invoker = createInvoker(
  ...
  // @LINE:70
  private[this] lazy val femr_ui_controllers_TriageController_indexPost57_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("triage")))
  )
  private[this] lazy val femr_ui_controllers_TriageController_indexPost57_invoker = createInvoker(
  ...
  // @LINE:71
  private[this] lazy val femr_ui_controllers_TriageController_deletePatientPost58_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("triage/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_TriageController_deletePatientPost58_invoker = createInvoker(
  ...
  // @LINE:73
  private[this] lazy val femr_ui_controllers_MedicalController_updateVitalsPost59_route = Route("POST",
  ...
  private[this] lazy val femr_ui_controllers_MedicalController_updateVitalsPost59_invoker = createInvoker(
  ...
  // @LINE:74
  private[this] lazy val femr_ui_controllers_MedicalController_newVitalsGet60_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("medical/newVitals")))
  )
  private[this] lazy val femr_ui_controllers_MedicalController_newVitalsGet60_invoker = createInvoker(
  ...
  // @LINE:75
  private[this] lazy val femr_ui_controllers_MedicalController_listVitalsGet61_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("medical/listVitals/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_MedicalController_listVitalsGet61_invoker = createInvoker(
  ...
  // @LINE:76
  private[this] lazy val femr_ui_controllers_MedicalController_editGet62_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("medical/edit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_MedicalController_editGet62_invoker = createInvoker(
  ...
  // @LINE:77
  private[this] lazy val femr_ui_controllers_MedicalController_editPost63_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("medical/edit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val femr_ui_controllers_MedicalController_editPost63_invoker = createInvoker(
  ...
  // @LINE:78
  private[this] lazy val femr_ui_controllers_MedicalController_indexGet64_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("medical")))
  )
  private[this] lazy val femr_ui_controllers_MedicalController_indexGet64_invoker = createInvoker(
  ...
  // @LINE:79
  private[this] lazy val femr_ui_controllers_MedicalController_indexPost65_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("medical")))
  )
  private[this] lazy val femr_ui_controllers_MedicalController_indexPost65_invoker = createInvoker(
  ...
  // @LINE:80
  private[this] lazy val femr_ui_controllers_MedicalController_prescriptionRowGet66_route = Route("GET",
  ...
  private[this] lazy val femr_ui_controllers_MedicalController_prescriptionRowGet66_invoker = createInvoker(
  ...
  // @LINE:81
  private[this] lazy val femr_ui_controllers_MedicalController_deleteExistingProblem67_route = Route("POST",
  ...
  private[this] lazy val femr_ui_controllers_MedicalController_deleteExistingProblem67_invoker = createInvoker(
  ...
  // @LINE:83
  private[this] lazy val femr_ui_controllers_ResearchController_indexGet68_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("research")))
  )
  private[this] lazy val femr_ui_controllers_ResearchController_indexGet68_invoker = createInvoker(
  ...
  // @LINE:84
  private[this] lazy val femr_ui_controllers_ResearchController_indexPost69_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("research")))
  )
  private[this] lazy val femr_ui_controllers_ResearchController_indexPost69_invoker = createInvoker(
  ...
  // @LINE:85
  private[this] lazy val femr_ui_controllers_ResearchController_exportPost70_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("research/exportData")))
  )
  private[this] lazy val femr_ui_controllers_ResearchController_exportPost70_invoker = createInvoker(
  ...
  // @LINE:87
  private[this] lazy val femr_ui_controllers_PDFController_index71_route = Route("GET",
  ...
  private[this] lazy val femr_ui_controllers_PDFController_index71_invoker = createInvoker(
  ...
  // @LINE:89
  private[this] lazy val femr_ui_controllers_SessionsController_delete72_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("logout")))
  )
  private[this] lazy val femr_ui_controllers_SessionsController_delete72_invoker = createInvoker(
  ...
  // @LINE:90
  private[this] lazy val femr_ui_controllers_SessionsController_editPasswordPost73_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("login/reset")))
  )
  private[this] lazy val femr_ui_controllers_SessionsController_editPasswordPost73_invoker = createInvoker(
  ...
  // @LINE:91
  private[this] lazy val femr_ui_controllers_SessionsController_createPost74_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("login")))
  )
  private[this] lazy val femr_ui_controllers_SessionsController_createPost74_invoker = createInvoker(
  ...
  // @LINE:92
  private[this] lazy val femr_ui_controllers_SessionsController_createGet75_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("login")))
  )
  private[this] lazy val femr_ui_controllers_SessionsController_createGet75_invoker = createInvoker(
  ...
  // @LINE:94
  private[this] lazy val femr_ui_controllers_ReferenceController_indexGet76_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("reference")))
  )
  private[this] lazy val femr_ui_controllers_ReferenceController_indexGet76_invoker = createInvoker(
  ...
  // @LINE:96
  private[this] lazy val femr_ui_controllers_HomeController_index77_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix)))
  )
  private[this] lazy val femr_ui_controllers_HomeController_index77_invoker = createInvoker(
  ...
  // @LINE:99
  private[this] lazy val controllers_Assets_versioned78_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("assets/"), DynamicPart("file", """.+""",false)))
  )
  private[this] lazy val controllers_Assets_versioned78_invoker = createInvoker(
  ...
  // @LINE:102
  private[this] lazy val femr_ui_controllers_FeedbackController_indexGet79_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("feedback")))
  )
  private[this] lazy val femr_ui_controllers_FeedbackController_indexGet79_invoker = createInvoker(
  ...
  // @LINE:103
  private[this] lazy val femr_ui_controllers_FeedbackController_indexPost80_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("feedback")))
  )
  private[this] lazy val femr_ui_controllers_FeedbackController_indexPost80_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:53
    case femr_ui_controllers_HistoryController_indexPatientGetWithRankedMatches44_route(params@_) =>
      call(params.fromPath[String]("first", None), params.fromPath[String]("last", None), params.fromPath[String]("phone", None), params.fromPath[String]("addr", None), params.fromPath[Long]("age", None), params.fromPath[String]("gender", None), params.fromPath[String]("city", None)) { (first, last, phone, addr, age, gender, city) =>
        femr_ui_controllers_HistoryController_indexPatientGetWithRankedMatches44_invoker.call(HistoryController_5.get.indexPatientGetWithRankedMatches(first, last, phone, addr, age, gender, city))
      }
  
    // @LINE:55
    case femr_ui_controllers_SearchController_handleSearch45_route(params@_) =>
      call(params.fromPath[String]("page", None)) { (page) =>
        femr_ui_controllers_SearchController_handleSearch45_invoker.call(SearchController_9.get.handleSearch(page))
      }
  
    // @LINE:56
    case femr_ui_controllers_SearchController_doesPatientExist46_route(params@_) =>
      call(params.fromPath[String]("query", None)) { (query) =>
        femr_ui_controllers_SearchController_doesPatientExist46_invoker.call(SearchController_9.get.doesPatientExist(query))
      }
  
    // @LINE:57
    case femr_ui_controllers_SearchController_doesPatientExistForSearch47_route(params@_) =>
      call(params.fromPath[String]("first", None), params.fromPath[String]("last", None), params.fromPath[String]("phone", None), params.fromPath[String]("addr", None), params.fromPath[Long]("age", None), params.fromPath[String]("gender", None), params.fromPath[String]("city", None)) { (first, last, phone, addr, age, gender, city) =>
        femr_ui_controllers_SearchController_doesPatientExistForSearch47_invoker.call(SearchController_9.get.doesPatientExistForSearch(first, last, phone, addr, age, gender, city))
      }
  
    // @LINE:58
    case femr_ui_controllers_SearchController_typeaheadPatientsJSONGet48_route(params@_) =>
      call { 
        femr_ui_controllers_SearchController_typeaheadPatientsJSONGet48_invoker.call(SearchController_9.get.typeaheadPatientsJSONGet())
      }
  
    // @LINE:60
    case femr_ui_controllers_SearchController_typeaheadCitiesJSONGet49_route(params@_) =>
      call { 
        femr_ui_controllers_SearchController_typeaheadCitiesJSONGet49_invoker.call(SearchController_9.get.typeaheadCitiesJSONGet())
      }
  
    // @LINE:61
    case femr_ui_controllers_SearchController_typeaheadDiagnosisJSONGet50_route(params@_) =>
      call { 
        femr_ui_controllers_SearchController_typeaheadDiagnosisJSONGet50_invoker.call(SearchController_9.get.typeaheadDiagnosisJSONGet())
      }
  
    // @LINE:62
    case femr_ui_controllers_SearchController_typeaheadMedicationsWithIDJSONGet51_route(params@_) =>
      call { 
        femr_ui_controllers_SearchController_typeaheadMedicationsWithIDJSONGet51_invoker.call(SearchController_9.get.typeaheadMedicationsWithIDJSONGet())
      }
  
    // @LINE:63
    case femr_ui_controllers_SearchController_typeaheadMedicationAdministrationsJSONGet52_route(params@_) =>
      call { 
        femr_ui_controllers_SearchController_typeaheadMedicationAdministrationsJSONGet52_invoker.call(SearchController_9.get.typeaheadMedicationAdministrationsJSONGet())
      }
  
    // @LINE:65
    case femr_ui_controllers_PhotoController_GetPatientPhoto53_route(params@_) =>
      call(params.fromPath[Integer]("id", None), params.fromQuery[Boolean]("showDefault", Some(false))) { (id, showDefault) =>
        femr_ui_controllers_PhotoController_GetPatientPhoto53_invoker.call(PhotoController_7.get.GetPatientPhoto(id, showDefault))
      }
  
    // @LINE:66
    case femr_ui_controllers_PhotoController_GetPhoto54_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        femr_ui_controllers_PhotoController_GetPhoto54_invoker.call(PhotoController_7.get.GetPhoto(id))
      }
  
    // @LINE:68
    case femr_ui_controllers_TriageController_indexPopulatedGet55_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        femr_ui_controllers_TriageController_indexPopulatedGet55_invoker.call(TriageController_4.get.indexPopulatedGet(id))
      }
  
    // @LINE:69
    case femr_ui_controllers_TriageController_indexGet56_route(params@_) =>
      call { 
        femr_ui_controllers_TriageController_indexGet56_invoker.call(TriageController_4.get.indexGet())
      }
  
    // @LINE:70
    case femr_ui_controllers_TriageController_indexPost57_route(params@_) =>
      call(params.fromQuery[Integer]("id", None)) { (id) =>
        femr_ui_controllers_TriageController_indexPost57_invoker.call(TriageController_4.get.indexPost(id))
      }
  
    // @LINE:71
    case femr_ui_controllers_TriageController_deletePatientPost58_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        femr_ui_controllers_TriageController_deletePatientPost58_invoker.call(TriageController_4.get.deletePatientPost(id))
      }
  
    // @LINE:73
    case femr_ui_controllers_MedicalController_updateVitalsPost59_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        femr_ui_controllers_MedicalController_updateVitalsPost59_invoker.call(MedicalController_19.get.updateVitalsPost(id))
      }
  
    // @LINE:74
    case femr_ui_controllers_MedicalController_newVitalsGet60_route(params@_) =>
      call { 
        femr_ui_controllers_MedicalController_newVitalsGet60_invoker.call(MedicalController_19.get.newVitalsGet())
      }
  
    // @LINE:75
    case femr_ui_controllers_MedicalController_listVitalsGet61_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        femr_ui_controllers_MedicalController_listVitalsGet61_invoker.call(MedicalController_19.get.listVitalsGet(id))
      }
  
    // @LINE:76
    case femr_ui_controllers_MedicalController_editGet62_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        femr_ui_controllers_MedicalController_editGet62_invoker.call(MedicalController_19.get.editGet(id))
      }
  
    // @LINE:77
    case femr_ui_controllers_MedicalController_editPost63_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        femr_ui_controllers_MedicalController_editPost63_invoker.call(MedicalController_19.get.editPost(id))
      }
  
    // @LINE:78
    case femr_ui_controllers_MedicalController_indexGet64_route(params@_) =>
      call { 
        femr_ui_controllers_MedicalController_indexGet64_invoker.call(MedicalController_19.get.indexGet())
      }
  
    // @LINE:79
    case femr_ui_controllers_MedicalController_indexPost65_route(params@_) =>
      call { 
        femr_ui_controllers_MedicalController_indexPost65_invoker.call(MedicalController_19.get.indexPost())
      }
  
    // @LINE:80
    case femr_ui_controllers_MedicalController_prescriptionRowGet66_route(params@_) =>
      call(params.fromPath[Integer]("index", None)) { (index) =>
        femr_ui_controllers_MedicalController_prescriptionRowGet66_invoker.call(MedicalController_19.get.prescriptionRowGet(index))
      }
  
    // @LINE:81
    case femr_ui_controllers_MedicalController_deleteExistingProblem67_route(params@_) =>
      call(params.fromPath[Integer]("patientId", None), params.fromPath[String]("problem", None)) { (patientId, problem) =>
        femr_ui_controllers_MedicalController_deleteExistingProblem67_invoker.call(MedicalController_19.get.deleteExistingProblem(patientId, problem))
      }
  
    // @LINE:83
    case femr_ui_controllers_ResearchController_indexGet68_route(params@_) =>
      call { 
        femr_ui_controllers_ResearchController_indexGet68_invoker.call(ResearchController_13.get.indexGet())
      }
  
    // @LINE:84
    case femr_ui_controllers_ResearchController_indexPost69_route(params@_) =>
      call { 
        femr_ui_controllers_ResearchController_indexPost69_invoker.call(ResearchController_13.get.indexPost())
      }
  
    // @LINE:85
    case femr_ui_controllers_ResearchController_exportPost70_route(params@_) =>
      call { 
        femr_ui_controllers_ResearchController_exportPost70_invoker.call(ResearchController_13.get.exportPost())
      }
  
    // @LINE:87
    case femr_ui_controllers_PDFController_index71_route(params@_) =>
      call(params.fromPath[Integer]("encounterId", None)) { (encounterId) =>
        femr_ui_controllers_PDFController_index71_invoker.call(PDFController_2.get.index(encounterId))
      }
  
    // @LINE:89
    case femr_ui_controllers_SessionsController_delete72_route(params@_) =>
      call { 
        femr_ui_controllers_SessionsController_delete72_invoker.call(SessionsController_14.get.delete())
      }
  
    // @LINE:90
    case femr_ui_controllers_SessionsController_editPasswordPost73_route(params@_) =>
      call { 
        femr_ui_controllers_SessionsController_editPasswordPost73_invoker.call(SessionsController_14.get.editPasswordPost())
      }
  
    // @LINE:91
    case femr_ui_controllers_SessionsController_createPost74_route(params@_) =>
      call { 
        femr_ui_controllers_SessionsController_createPost74_invoker.call(SessionsController_14.get.createPost())
      }
  
    // @LINE:92
    case femr_ui_controllers_SessionsController_createGet75_route(params@_) =>
      call { 
        femr_ui_controllers_SessionsController_createGet75_invoker.call(SessionsController_14.get.createGet())
      }
  
    // @LINE:94
    case femr_ui_controllers_ReferenceController_indexGet76_route(params@_) =>
      call { 
        femr_ui_controllers_ReferenceController_indexGet76_invoker.call(ReferenceController_21.get.indexGet())
      }
  
    // @LINE:96
    case femr_ui_controllers_HomeController_index77_route(params@_) =>
      call { 
        femr_ui_controllers_HomeController_index77_invoker.call(HomeController_8.get.index())
      }
  
    // @LINE:99
    case controllers_Assets_versioned78_route(params@_) =>
      call(params.fromPath[String]("file", None)) { (file) =>
        controllers_Assets_versioned78_invoker.call(Assets_17.versioned(file))
      }
  
    // @LINE:102
    case femr_ui_controllers_FeedbackController_indexGet79_route(params@_) =>
      call { 
        femr_ui_controllers_FeedbackController_indexGet79_invoker.call(FeedbackController_16.get.indexGet())
      }
  
    // @LINE:103
    case femr_ui_controllers_FeedbackController_indexPost80_route(params@_) =>
      call { 
        femr_ui_controllers_FeedbackController_indexPost80_invoker.call(FeedbackController_16.get.indexPost())
      }
  }
}
