...
<table id="vitalTable" cellspacing="0">
    ...
    <tbody>
        ...
        <tr id="cholesterol">
            <th>Cholesterol</th>
            """),_display_(/*153.14*/for(dateIndex <- 1 to vitalMap.getDateListChronological.size) yield /*153.75*/ {_display_(Seq[Any](format.raw/*153.77*/("""
                """),format.raw/*154.17*/("""<td> """),_display_(/*154.23*/outputYesOrNA(vitalMap.get("cholesterol", vitalMap.getDate(dateIndex - 1)))),format.raw/*154.98*/("""</td>
            """)))}),format.raw/*155.14*/("""
        """),format.raw/*156.9*/("""</tr>
        <tr id="hypertension">
            <th>Hypertension</th>
            """),_display_(/*159.14*/for(dateIndex <- 1 to vitalMap.getDateListChronological.size) yield /*159.75*/ {_display_(Seq[Any](format.raw/*159.77*/("""
                """),format.raw/*160.17*/("""<td> """),_display_(/*160.23*/outputYesOrNA(vitalMap.get("hypertension", vitalMap.getDate(dateIndex - 1)))),format.raw/*160.99*/("""</td>
            """)))}),format.raw/*161.14*/("""
        """),format.raw/*162.9*/("""</tr>
    </tbody>
</table>"""))
